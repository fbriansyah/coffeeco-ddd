Firstly, run docker-compose up. This will bring up mongo on port 27017 and mongo-express on 8081. If you see any errors, make sure these ports don't have anything else running on them.
